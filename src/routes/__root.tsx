...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "RideTracks is the all-in-one business dashboard for taxi and rideshare drivers. Track earnings, expenses, fleet deductions, cash payments, and profit with complete clarity." },
      { name: "author", content: "RideTracks" },
      { property: "og:title", content: "RideTracks — Track every ride. Know every złoty." },
      { property: "og:description", content: "RideTracks is the all-in-one business dashboard for taxi and rideshare drivers. Track earnings, expenses, fleet deductions, cash payments, and profit with complete clarity." },
